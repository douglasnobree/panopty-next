    ...
    <>
      <div className='container mx-auto p-6 bg-slate-100 min-h-screen'>
        <Card>
          <CardHeader>
            <div className='flex items-center gap-4'>
              ...
              <CardTitle>Calculo de QIP</CardTitle>
            </div>
            <Button onClick={t} className='flex items-center gap-2'>
        ...
        <div className='mt-6'>
              ...
              <UITable>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>POTÊNCIA UNIT.</TableHead>
                    <TableHead>PERDAS</TableHead>
                    <TableHead>POTÊNCIA TOTAL (KW)</TableHead>
                    <TableHead>CONSUMO (kWh/mês)</TableHead>
                    <TableHead></TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {lamps.map((lamp, i) => {
                    ...
                    const totalPowerFormatted = parseFloat(
                      totalPower.toFixed(2)
                    );
                    const consumoMes = Math.round(
                      totalPower * 12 * (days || 0)
                    );
                    return (
                      <TableRow key={i}>
                        ...
                        <TableCell>
                          <Input
                            ...
                            value={lamp.potencia}
                            onChange={(e) =>
                              handleInputChange(i, e, 'potencia')
                            }
                        ...
                        <TableCell>{totalPowerFormatted}</TableCell>
                        <TableCell>{consumoMes}</TableCell>
                        <TableCell>
                          <Button variant='ghost' onClick={() => removeLamp(i)}>
                            <X className='h-4 w-4' />
                          </Button>
                        </TableCell>
                      </TableRow>
          ...
          <div className='mt-4'>
            <Button onClick={addLamp} className='w-full'>
              Nova Lâmpada
            </Button>
          </div>
        </div>
